<template>
  <div class="mx-auto text-center max-w-screen-xl">
    <Card>
      ...
      <p class="text-2xl font-bolder mb-6">my name is Simone</p>
      <p class="text-lg">I'm a software engineer from 🇮🇹</p>
    </Card>
    <Card>
      <p class="text-2xl font-bold">You can find me on</p>
      <div class="flex flex-col">
        <div class="flex justify-center mb-1">
          <a href="https://github.com/simone98dm" target="_blank">
            <SvgIcon name="github" class="w-10 h-10" />
          </a>
          <a href="https://www.linkedin.com/in/simone-d-b40a2a6b/" target="_blank">
            <SvgIcon name="linkedin" class="w-10 h-10" />
          </a>
        </div>
        or
        <a href="https://www.buymeacoffee.com/simone98dm" target="_blank" class="mx-auto p-3">
          <img
