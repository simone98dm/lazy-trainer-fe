...
<template>
  ...
  <h1
    class="flex flex-col text-center my-20 text-pink-600"
    v-else
  >
  ...
  <div
    class="text-center text-slate-500 mb-3 dark:text-slate-500 text-slate-300"
  >
    Next activty:
    <h1
      v-if="timerStore.nextActivity"
      class="text-4xl font-bolder"
    >
