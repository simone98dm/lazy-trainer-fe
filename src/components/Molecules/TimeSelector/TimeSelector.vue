...
<template>
  <Modal :show="showModal" @close="showModal = false" title="Select time" button-text="Select">
    <template #content>
      <div class="w-full">
    ...
    <template #actions>
      <Button label="Select" @click="showModal = false" icon="check" :color="ButtonColor.SUCCESS" />
    </template>
  </Modal>
